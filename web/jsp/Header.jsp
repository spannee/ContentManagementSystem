 ...
 * Functionality:	This is a Jsp, which will display the header for login
 * 
 * Models Used	:	
    ...
    <div id="header">
      ...
      <div id="menubar">
	   ...
	   <li><html:link page="/guestUserNavigation.do?mode=signin"><bean:message key="label.SignIn"/></html:link></li>
          ...
          <li><html:link page="/LoginNavigation.do?mode=doSignUp"><bean:message key="label.SignUp"/></html:link></li>
	  <li><html:link page="/LoginNavigation.do?mode=doBacktoWelcome"><bean:message key="label.Back"/></html:link></li>
